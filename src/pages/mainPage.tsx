  ...
  return (
    <div className="relative h-screen w-full bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 grid h-full w-full grid-cols-4 grid-rows-[auto_1fr_auto] gap-2 p-2">
        ...
        <button className="relative flex col-span-2 border-1 h-20 rounded-xl items-center justify-center">
          <div className="absolute left-0 top-0 bottom-0 w-[25%] flex items-center justify-center">
            <ChevronDown />
          </div>
          <span className="text-xl flex justify-center">Room Lights</span>
        </button>
      </div>
    </div>
  );
